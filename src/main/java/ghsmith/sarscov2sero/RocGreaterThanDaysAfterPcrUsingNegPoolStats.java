...
public class RocGreaterThanDaysAfterPcrUsingNegPoolStats {
    ...
    static public void main(String args[]) throws IOException {
        ...
        for(float cutOff : seroCases.stream().sorted(Comparator.comparingDouble(seroCase -> seroCase.ourResultSdAboveNegPoolMean)).map(seroCase -> seroCase.ourResultSdAboveNegPoolMean).collect(Collectors.toList())) {
